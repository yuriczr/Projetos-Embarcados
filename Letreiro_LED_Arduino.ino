...
char mensaje1[] = " ENGRENA :"; //Escriba el mensaje a desplegar 
char mensaje2[] = " Solucoes em Engenharia  UnB - Gama";
...
void loop(){
  ...
  printStringWithShift(mensaje1, 30);       // El ultimo termino se usa para la velocidad del mensaje 
  printStringWithShift(mensaje2, 30);
